...
export const Chats = ({ chanelUnique, setChanelUnique,chat,setChat,setUsers,setperfilUser,setcolor}) => {
   ...
   useEffect( () => {
      axios.get('https://chatowlapp-2syg.onrender.com/direct/messages',axiosConfig)
         .then((response) => {
   ...
   const handleSubmitInput = (e) => {
      ...
      if(chanelUnique[0].id_channel){
         ...
         axios.post('https://chatowlapp-2syg.onrender.com/messages', objMessage,axiosConfig)
         .then(() => {
         ...
         axios.post('https://chatowlapp-2syg.onrender.com/direct/messages', dataDirectMessage,axiosConfig)
         .then(() => {
